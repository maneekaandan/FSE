...
beforeEach(() => {
    ...
    it('should check the load function', () => {
        const result = component.loadUser();
        expect(component.loadUser()).toBeTruthy;
    });
    ...
    it('should Check the page header', async(() => {
      ...
      it('should sort by First Name', async(() => {
        component.sortTypeFirstName();
        expect(component.sortTypeFirstName).toBeTruthy();
      }));
    
      it('should sort by Last Name', async(() => {
        component.sortTypeLastName();
        expect(component.sortTypeLastName).toBeTruthy();
      }));
    
      it('should sort by Employee ID', async(() => {
        component.sortTypeEmpID();
        expect(component.sortTypeEmpID).toBeTruthy();
      }));
